    ...
    .solutions-bg {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(135deg, rgba(58,123,213,0.95), rgba(0,210,255,0.95));
        z-index: 0;
    }
    ...
    .solutions-section .section-heading h2::after {
        background: white;
    }
    ...
    .solutions-section .card:hover .solution-icon {
        transform: scale(1.1);
        background-color: rgba(58, 123, 213, 0.2) !important;
    }
    
    .solutions-section .text-muted {
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <a href="php/LoyaltyPoints.php" class="btn btn-success btn-lg">Ver Beneficios <i class="fas fa-gift ms-2"></i></a>
                        </div>
                    </div>
                </div>
   ...
   <section class="solutions-section" id="solutions">
    <div class="solutions-bg"></div>
    <div class="container position-relative">
        <div class="section-heading text-center">
            <h2>Soluciones para cada necesidad</h2>
            <p>MoveSync se adapta a diferentes perfiles de usuarios y escenarios de movilidad</p>
        </div>
        <div class="row g-4">
            <div class="col-md-4 animate-fade-up">
                <div class="card h-100 border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        <div class="solution-icon mb-3 d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 60px; height: 60px; background-color: rgba(58,123,213,0.1);">
                            <i class="fas fa-briefcase text-primary fa-lg"></i>
                        </div>
                        <h4>Profesionales</h4>
                        <p>Optimiza tu ruta al trabajo con información en tiempo real y alertas personalizadas. Ahorra hasta 45 minutos diarios en tus desplazamientos.</p>
                        <ul class="list-unstyled mt-3">
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Planificación de rutas diarias</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Alertas de retrasos</li>
                            <li><i class="fas fa-check-circle text-success me-2"></i> Horarios personalizados</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4 animate-fade-up delay-1">
                <div class="card h-100 border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h4>Estudiantes</h4>
                        <p>Llega puntual a clase con rutas optimizadas según horarios académicos. Benefíciate de descuentos especiales y tarifas reducidas.</p>
                        <ul class="list-unstyled mt-3">
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Descuentos estudiantiles</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Rutas a campus universitarios</li>
                            <li><i class="fas fa-check-circle text-success me-2"></i> Integración con calendarios académicos</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4 animate-fade-up delay-2">
                <div class="card h-100 border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        ...
                        <h4>Empresas</h4>
                        <p>Soluciones corporativas para gestionar la movilidad de tus empleados. Reduce la huella de carbono y optimiza costes de transporte.</p>
                        <ul class="list-unstyled mt-3">
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Planes corporativos</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Reportes de sostenibilidad</li>
                            <li><i class="fas fa-check-circle text-success me-2"></i> Gestión de flotas</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="footer-legal" style="color: rgba(255, 255, 255, 0.7); font-size: 0.85rem; line-height: 1.6;">
                    <p><i class="fas fa-shield-alt me-2"></i> <strong>Protección de datos:</strong> Sus datos personales son procesados conforme al RGPD (UE) 2016/679 y LOPDGDD 3/2018.</p>
                    <p><i class="fas fa-cookie-bite me-2"></i> <strong>Cookies:</strong> Este sitio utiliza cookies técnicas esenciales y analíticas para mejorar la experiencia del usuario.</p>
                    <p><i class="fas fa-balance-scale me-2"></i> <strong>Aviso legal:</strong> La información proporcionada en esta web tiene carácter meramente informativo.</p>
                    <p><i class="fas fa-universal-access me-2"></i> <strong>Accesibilidad:</strong> Cumplimos con el Real Decreto 1112/2018 sobre accesibilidad de sitios web.</p>
                </div>
            </div>
        </div>
